...
public class MyEc2InstanceStack extends Stack {
    public MyEc2InstanceStack(final Construct scope, final String id) {
        this(scope, id, null);
    }

    public MyEc2InstanceStack(final Construct scope, final String id, final StackProps props) {
